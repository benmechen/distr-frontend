...
export type LoginMutation = { __typename?: 'Mutation' } & {
    login?: Maybe<
        { __typename?: 'Tokens' } & Pick<Tokens, 'accessToken' | 'refreshToken'>
    >;
};
...
export type IsRegisteredQuery = { __typename?: 'Query' } & {
    userRegistered: { __typename?: 'UserExistsResponse' } & Pick<
        UserExistsResponse,
        'exists' | 'name'
    >;
};
...
export type DeleteSystemMutation = { __typename?: 'Mutation' } & {
    systemDelete: { __typename?: 'System' } & Pick<System, 'id'>;
};
...
export type UpdateSystemMutation = { __typename?: 'Mutation' } & {
    systemUpdate: { __typename?: 'System' } & SystemRowFragment;
};
...
export type CreateSystemMutation = { __typename?: 'Mutation' } & {
    systemCreate: { __typename?: 'System' } & SystemRowFragment;
};

export type SystemRowFragment = { __typename?: 'System' } & Pick<
    System,
    'id' | 'name'
> & {
        status: { __typename?: 'StatusOverview' } & Pick<
            StatusOverview,
            'healthy' | 'unhealthy'
        >;
        deployments: Array<
            { __typename?: 'Deployment' } & Pick<Deployment, 'id' | 'name'>
        >;
    };
...
export type GetSystemsQuery = { __typename?: 'Query' } & {
    systems: { __typename?: 'SystemConnection' } & {
        edges?: Maybe<
            Array<
                { __typename?: 'SystemEdge' } & {
                    node: { __typename?: 'System' } & SystemRowFragment;
                }
            >
        >;
    };
...
export type CreateServiceMutation = { __typename?: 'Mutation' } & {
    serviceCreate: { __typename?: 'Service' } & SingleServiceFragment;
};
...
export type SearchServicesQuery = { __typename?: 'Query' } & {
    services: { __typename?: 'ServiceConnection' } & {
        edges?: Maybe<
            Array<
                { __typename?: 'ServiceEdge' } & {
                    node: { __typename?: 'Service' } & ServiceRowFragment;
                }
            >
        >;
    };
...
export type ServiceRowFragment = { __typename?: 'Service' } & Pick<
    Service,
    'id' | 'name' | 'summary' | 'platform' | 'verified'
>;
...
export type UpdateUserMutation = { __typename?: 'Mutation' } & {
    userUpdate?: Maybe<{ __typename?: 'User' } & UserDetailsFragment>;
};
...
export type SingleOrganisationFragment = { __typename?: 'Organisation' } & Pick<
    Organisation,
    'id' | 'name'
> & {
        members: Array<
...
export type GetServiceQuery = { __typename?: 'Query' } & {
    service?: Maybe<{ __typename?: 'Service' } & SingleServiceFragment>;
};

export type SingleServiceFragment = { __typename?: 'Service' } & Pick<
    Service,
    | 'id'
    | 'name'
    | 'summary'
    ...
    | 'documentationURL'
    | 'sourceCodeURL'
> & { author: { __typename?: 'Organisation' } & Pick<Organisation, 'name'> };
...
export type CreateResourceMutation = { __typename?: 'Mutation' } & {
    resourceCreate: { __typename?: 'ResourceCreateResponse' } & {
        resource: { __typename?: 'Resource' } & Pick<
            Resource,
            'id' | 'name' | 'status'
        > & {
                usage?: Maybe<
                    { __typename?: 'Usage' } & Pick<
                        Usage,
                        'current' | 'limit' | 'type'
                    >
                >;
                deployment: { __typename?: 'Deployment' } & Pick<
                    ...
                    'id' | 'name'
                >;
                service: { __typename?: 'Service' } & ServiceDetailsFragment;
            };
        details: Array<
            { __typename?: 'Property' } & Pick<Property, 'name'> & {
                    value?: Maybe<
                        { __typename?: 'Value' } & Pick<
                            Value,
                            'stringValue' | 'boolValue' | 'numberValue'
                        >
                    >;
                }
        >;
...
export type GetServiceDetailsQuery = { __typename?: 'Query' } & {
    service?: Maybe<{ __typename?: 'Service' } & ServiceDetailsFragment>;
};
...
export type GetServiceInputsQuery = { __typename?: 'Query' } & {
    service?: Maybe<
        { __typename?: 'Service' } & {
            inputs: Array<{ __typename?: 'Field' } & SingleInputFragment>;
        } & ServiceDetailsFragment
    >;
};

export type ServiceDetailsFragment = { __typename?: 'Service' } & Pick<
    Service,
    'id' | 'name'
>;

export type SingleFlatInputFragment = { __typename?: 'Field' } & Pick<
    Field,
...
export type SingleInputFragment = { __typename?: 'Field' } & {
    fields?: Maybe<Array<{ __typename?: 'Field' } & SingleFlatInputFragment>>;
} & SingleFlatInputFragment;

export type SingleResourceFragment = { __typename?: 'Resource' } & Pick<
    Resource,
    'id' | 'name' | 'status'
> & {
        usage?: Maybe<
            { __typename?: 'Usage' } & Pick<Usage, 'current' | 'limit' | 'type'>
        >;
        details: Array<
            { __typename?: 'Property' } & Pick<Property, 'name'> & {
                    value?: Maybe<
...
export type DeleteResourceMutation = { __typename?: 'Mutation' } & {
    resourceDelete: { __typename?: 'Resource' } & Pick<Resource, 'id'>;
};
...
export type GetResourceQuery = { __typename?: 'Query' } & {
    resource: { __typename?: 'Resource' } & SingleResourceFragment;
};
...
export type UpdateResourceMutation = { __typename?: 'Mutation' } & {
    resourceUpdate: { __typename?: 'Resource' } & SingleResourceFragment;
};
...
export type CreateDeploymentMutation = { __typename?: 'Mutation' } & {
    deploymentCreate: { __typename?: 'Deployment' } & SingleDeploymentFragment;
};
...
export type DeleteDeploymentMutation = { __typename?: 'Mutation' } & {
    deploymentDelete: { __typename?: 'Deployment' } & Pick<Deployment, 'id'>;
};
...
export type UpdateDeploymentMutation = { __typename?: 'Mutation' } & {
    deploymentUpdate: { __typename?: 'Deployment' } & SingleDeploymentFragment;
};

export type ResourceRowFragment = { __typename?: 'Resource' } & Pick<
    Resource,
    'id' | 'name' | 'status'
> & {
        usage?: Maybe<
            { __typename?: 'Usage' } & Pick<Usage, 'type' | 'limit' | 'current'>
        >;
    };

export type SingleDeploymentFragment = { __typename?: 'Deployment' } & Pick<
    Deployment,
    'id' | 'name'
> & {
        status: { __typename?: 'StatusOverview' } & Pick<
            ...
            'healthy' | 'unhealthy'
        >;
        resources: Array<{ __typename?: 'Resource' } & ResourceRowFragment>;
    };
...
export type GetDeploymentsForSystemQuery = { __typename?: 'Query' } & {
    system: { __typename?: 'System' } & Pick<System, 'id' | 'name'> & {
            deployments: Array<
                { __typename?: 'Deployment' } & SingleDeploymentFragment
            >;
        };
};
...
export function useGetSystemsQuery(
    options: Omit<Urql.UseQueryArgs<GetSystemsQueryVariables>, 'query'> = {},
) {
    return Urql.useQuery<GetSystemsQuery>({
...
export function useSearchServicesQuery(
    options: Omit<
        Urql.UseQueryArgs<SearchServicesQueryVariables>,
        'query'
    > = {},
) {
    return Urql.useQuery<SearchServicesQuery>({
...
export function useAddMemberMutation() {
    return Urql.useMutation<AddMemberMutation, AddMemberMutationVariables>(
        AddMemberDocument,
    );
}
...
export function useGetOrganisationQuery(
    options: Omit<
        Urql.UseQueryArgs<GetOrganisationQueryVariables>,
        'query'
    > = {},
) {
    return Urql.useQuery<GetOrganisationQuery>({
...
export function useGetServiceQuery(
    ...
    return Urql.useQuery<GetServiceQuery>({
...
export function useGetServiceDetailsQuery(
    options: Omit<
        Urql.UseQueryArgs<GetServiceDetailsQueryVariables>,
        'query'
    > = {},
) {
    return Urql.useQuery<GetServiceDetailsQuery>({
...
export function useGetServiceInputsQuery(
    options: Omit<
        Urql.UseQueryArgs<GetServiceInputsQueryVariables>,
        'query'
    > = {},
) {
    return Urql.useQuery<GetServiceInputsQuery>({
        query: GetServiceInputsDocument,
        ...options,
    });
}
...
export function useGetResourceQuery(
    options: Omit<Urql.UseQueryArgs<GetResourceQueryVariables>, 'query'> = {},
) {
    return Urql.useQuery<GetResourceQuery>({
...
export function useGetDeploymentsForSystemQuery(
    options: Omit<
        Urql.UseQueryArgs<GetDeploymentsForSystemQueryVariables>,
        'query'
    > = {},
) {
    return Urql.useQuery<GetDeploymentsForSystemQuery>({
